...
class Scanner {
 public:
  ...
  {
    goal_poses.at(0) << 0.07975098222703264, 0.1912801323522601, 0.016800910318580282, -1.780517308656089, -0.43001809130774604, 2.840706754071704, 1.2763794419674155;
    goal_poses.at(1) << 0.07423677020502224, -0.16895207870170834, -0.01739294999455757, -2.148493787373226, -0.4594188762764029, 2.9986082050005596, 1.2267582378234292;
    goal_poses.at(2) << 0.09911098749072929, -0.1239977193691705, -0.00531071934126161, -2.048764962082538, -0.4053728662024609, 2.8943427835385838, 1.2215459212439252;
    goal_poses.at(3) << -0.10126473527490241, -0.9280972911700696, 0.2613660008405384, -2.6643017023718905, -0.24911827067092612, 3.21774939769697, 1.260410547982497;
    goal_poses.at(4) << 0.021348165159685576, -1.3986401582171828, 0.2485869409865171, -2.8720675798107402, -0.2596319724188911, 3.058391145547231, 1.2582345738063254;
    goal_poses.at(5) << 0.07564599031697936, -1.7455189008841003, 0.20152863198662244, -2.997883944977146, -0.3529262597649186, 2.978800730860714, 1.3184717867661728;
    goal_poses.at(6) << 0.05693500763320076, -1.4830985697520966, 0.6208186084178455, -2.801915834330165, -0.22718658990903615, 2.9779661087989724, 1.3213901261949699;
    goal_poses.at(7) << -0.3040832270592223, -1.1170643709856485, 0.8441226244642022, -2.5022547237563177, -0.20441106857447605, 3.013031459465425, 1.3456559313652996;
    goal_poses.at(8) << -0.6924211229662991, -0.8604797595174742, 1.0764434815526132, -2.2717824239898143, -0.18019897478719868, 3.014822743472443, 1.3447165227648283;
    goal_poses.at(9) << -1.078069790668655, -0.8071784893457317, 1.449906561240025, -1.8885478407896785, -0.12678724956993626, 2.786309055169423, 1.2694327265799883;
    goal_poses.at(10) << 0.9208467507134637, -0.7069723573017217, -1.058362939081694, -2.0975300465988833, -0.2728774133437191, 2.7571864351872293, 0.8424597964588909;
    goal_poses.at(11) << 0.6311146891707178, -0.9951198768922268, -0.8815044550454316, -2.2933741094354994, -0.33896638763599984, 2.8065129842521146, 0.8411473497466908;
    goal_poses.at(12) << 0.38011963067974963, -1.3720267832039361, -0.7637782996345541, -2.427091076814473, -0.37758252994543134, 2.7370390356381735, 0.8413532063090357;
    goal_poses.at(13) << 0.9900714515761325, -1.7453625325281177, 1.437348222528641, -2.760951613952724, -0.9397039766276116, 2.060468782265981, 2.276330765972267;
    goal_poses.at(14) << 0.19544769447960644, 0.5514320451719299, 0.09095485297256316, -1.368262226205125, -0.5614982806843187, 2.6206327856381733, 1.2989454467564898;
  }
 ...
 private:
  ...
  void sendGoalPose(){
    ...
    tf::matrixEigenToMsg(goal_poses.at(nextPose), outputPose);
  ...
  void comparePose(const sensor_msgs::JointStateConstPtr& joint_state){
    ...
    for (int i = 0; i < 7; ++i) {
      ...
      rounded_goal_pose.position[i] = round(goal_poses.at(nextPose)[i]*rounding_precision)/rounding_precision;
    }
